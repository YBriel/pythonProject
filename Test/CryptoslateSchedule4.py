...
def postTem(postId, url):
   ...
   # params["content"] = article_p.text
    ...
    headers2 = {
        "Content-Type": "application/json;charset=UTF-8",
        "Authorization": 'eyJhbGciOiJIUzUxMiJ9.eyJ1c2VyX2lkIjoiZmJmNzk0NDgyNDE1NDJmOGEwMjc3YTYzODk2ZDg3MTAiLCJmcm9tLXNvdXJjZSI6MSwiZXhwIjoxNjk1NzI0ODQ0fQ.P-W3j8w5Eod0h-3hjMe2YU-jZDHP6JOs9uhe22skWf5OCNGtAMbDKI1hXo8nUf8Nw8MRXcft4WWVqTTQG228bQ'
    }
...
def time_printer():
    ...
    for i in range(1, 2):
        ...
        for post in div_list_post:
            ...
            try:
                print("请求 ")
                postTem(post.find('article')['id'], post.find('a')['href'])
